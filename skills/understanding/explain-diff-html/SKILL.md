...
Author: Geoffrey Litt. Not written by Doruk Tarhan — imported verbatim (HTML variant only;
the gist also has a Notion variant, not used here). See PROVENANCE.md.
-->
